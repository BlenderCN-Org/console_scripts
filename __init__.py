...
__reload__.execute(locals())
# end of section 2

import bpy
from .utils import console_writer
# a more generic way of
# from CURRENT_DIRECTORY_NAME.utils import console_writer
...
from . import __register__

def register():
    __register__.register(__name__)

def unregister():
    __register__.unregister(__name__)
